...
class Strategy(bt.Strategy):
    ...
    def __init__(self):
        ...
        self.add_timer(
            ...
            weekdays=self.p.rebal_monthday,  # 每Week 周1触发再平衡
            weekcarry=True,  # 若再平衡日不是交易日，则顺延触发notify_timer
        )
    ...
    def rebalance_portfolio(self):
        ...
        # 2 再做排序挑选过程
        self.ranks.sort(key=lambda d: d.pct_chg, reverse=True)  # 按成交量从大到小排序
        self.ranks = self.ranks[-5:]  # 取前num_volume名
...
def run2():
    ...
    for df in dfs:
        ...
        data = PandasDataExtend(
                ...
                # fromdate=datetime(2020, 1, 1),  # 起始日2002, 4, 1
                # todate=datetime(2020, 12, 31),  # 结束日 2015, 12, 31
                plot=True
